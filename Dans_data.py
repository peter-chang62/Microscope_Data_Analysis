...
# ____________________________________ phase correction ________________________________________________________________
opt = td.Optimize(data)
opt.phase_correct(1500)

# __________________________________________ plotting __________________________________________________________________
