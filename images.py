...
def group_3(plot=True):
    path = r"/home/peterchang/SynologyDrive/Research_Projects/Microscope/Images/11-07-2022/"
    s1 = np.load(path + "stage1_5120_6480_stage2_8450_8800_step_10_ppifg_74180.npy")
    s2 = np.load(path + "stage1_5120_6480_stage2_8810_9060_step_10_ppifg_74180.npy")
    s = np.hstack((s1, s2))
...
def num_4(plot=True):
    path = r"/home/peterchang/SynologyDrive/Research_Projects/Microscope/Images/11-08-2022/"
